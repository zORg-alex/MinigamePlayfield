...
public class RequireInterfaceDrawer : PropertyDrawer {
    ...
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label) {
        ...
        if (property.propertyType == SerializedPropertyType.ObjectReference) {
            ...
            // Draw property field.
            var newVal = EditorGUI.ObjectField(position, label, property.objectReferenceValue, typeof(GameObject), true) as GameObject;
            property.objectReferenceValue = newVal.GetComponent(requiredAttribute.requiredType);
